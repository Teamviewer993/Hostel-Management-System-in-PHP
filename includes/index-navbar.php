...
<nav class="z-depth-0 transparent ">
    ...
    <ul class="sidenav " id="mobile-demo ">
	    ...
	    if (isset($_SESSION['userId'])) {
		    echo '
		   <li><a href="users/profile.php" class="black-text">My Profile</a></li>
		   <li><a href="includes/logout.inc.php">Logout</a></li>
		   <div class="divider"></div>
			<li><a class="black-text " href="# ">About Us</a></li>
			<li><a class="black-text " href="# ">Contact Us</a></li>';
	} else {
			echo '<li><a class="black-text " href="users/signup.php ">Register</a></li>
		   <li><a class="black-text " href="users/login.php ">Login</a></li>
		   <div class="divider"></div>
